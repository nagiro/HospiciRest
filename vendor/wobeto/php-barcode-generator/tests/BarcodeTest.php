...
class BarcodeTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $generator = new Wobeto\Barcode\BarcodeGeneratorPNG();
    ...
    {
        $generator = new Wobeto\Barcode\BarcodeGeneratorSVG();
    ...
    {
        $generator = new Wobeto\Barcode\BarcodeGeneratorHTML();
        $generated = $generator->getBarcode('081231723897', $generator::TYPE_CODE_128);
    ...
    {
        $generator = new Wobeto\Barcode\BarcodeGeneratorJPG();
