...
Vue.component('form-inscripcio-espai', {        
    ...
    methods: {
        submitHandler: function() {
            ...
            let FD = new FormData();
            FD.append('DadesFormulari', this.formValues);
    ...
    <div>
        ...
        <formulate-input type="checkbox" name="RESERVAESPAIS_Espais" label="Quins espais vols demanar?" validation="required" :options = "EspaisDisponiblesEntitat.map(function(E) { return E.ESPAIS_Nom } )" placeholder = "-- Escull una opció -- "></formulate-input>
        ...
        <formulate-input type="submit" :label="( isFormLoading ? 'Enviant...' : 'Fes la petició')" :disabled = "isFormLoading"></formulate-input>                                                                                            
